		 ...
		 <div id="mainmenu">
			...
			$this->widget('zii.widgets.CMenu', array(
				'items' => array(
					...
					array('label' => 'Search', 'url' => array('/tmdb/search')),
					/** @todo would like to provide linsk like /users/username instead of that link */
					array('label' => 'My profile', 'url' => array('/users/view','asd' => 3), 'visible' => !Yii::app()->user->isGuest),					
